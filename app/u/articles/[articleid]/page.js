    ...
    <div className="mt-12 mb-12 space-y-24 mx-auto max-w-screen-xl">
     <div className="bg-white border border-gray-200 p-6 rounded-md  w-full">
      ...
      <div className="bg-gray-50 p-5 rounded-md">
        ...
        أبو سعيد الحسن بن أبي الحسن يسار، من سادات التابعين وكبرائهم، شيخ أهل البصرة وسيد أهل زمانه علماً وعملاً، كان فقيهاً ثقة مأموناً فصيحاً عابداً ناسكاً كان واحدًا من الفقهاء الزهاد الذي بلغ ذكرهم وحكمتهم الآفا
          <br /><br />
          تشرب العلم والحكمة من الصحابة الكرام الذين أدركهم وعايشهم فنال قسطًا من نور النبوة.
قال الأعمش: مازال الحسن يعي الحكمة حتى نطق بها وكان إذا ذكر عند أبي جعفر – يعني الباقر، قال ذاك الذي يشبه كلامه كلام الأنبياء.
          <br /><br />
