      ...
      <header className="bg-white">
        <div className="bg-blue-50 mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            ...
            <ul className="mt-8 hidden  lg:flex justify-start gap-6 sm:mt-0 sm:justify-end">
              <li>
                <a
                  href="#"
                  rel="noreferrer"
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="flex gap-4">
                ...
                <div className="">
                  <Link
                    className="rounded-md font-bold flex items-center gap-2 bg-green-500 px-5 py-2.5 text-sm  text-white shadow"
                    href="/login"
                  >
                    <FaWhatsapp size={22} color="white" />
                    <span className="hidden md:block"> تواصل معنا</span>
                  </Link>
                </div>
              </div>
  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      ...
      <div className="md:flex md:items-center md:gap-12">
        ...
        <p className="mt-6 max-w-md text-start leading-relaxed text-gray-500 sm:max-w-xs sm:text-right">
        موقع الإسلام سؤال وجواب موقع دعوي، علمي، تربوي، يهدف إلى تقديم الاستشارات والإجابات العلمية المؤصلة بشكل واف وميسر، ويقوم بالإشراف على هذه الإجابات الشيخ محمد صالح المنجد  حفظه الله. 
        </p>

        <ul className="mt-8 hidden  lg:flex justify-start gap-6 sm:mt-8 sm:justify-start">
              <li>
                <a
                  href="#"
                  rel="noreferrer"
      ...
      <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
        <div className="text-center sm:text-right">
          <p className="text-lg font-medium text-gray-900">عن الموقع</p>
        ...
        <div className="text-center sm:text-right">
          <p className="text-lg font-medium text-gray-900">ماذا نقدم</p>
          ...
          <ul className="mt-8 space-y-4 text-sm">
            ...
            <li>
              <a className="text-gray-700 transition hover:text-gray-700/75" href="#"> مسابقات حول الأسماء الحسنى </a>
            </li>
        ...
        <div className="text-center sm:text-right">
          <p className="text-lg font-medium text-gray-900">روابط أخرى</p>
        ...
        <div className="text-center sm:text-left">
          <p className="text-lg font-medium text-gray-900">معلومات الإتصال</p>
    ...
    <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        ...
        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2022 الإسلام</p>
      </div>
    </div>
  </div>
</footer>
