...
const IsmAllah = ({ ismallah }) => {
  return (
   <div>
    ...
    <p className="bg-white text-center  text-blue-900 cursor-pointer w-full p-1">القرآن</p>
    <p className="bg-white text-center  text-blue-900 cursor-pointer w-full p-1">السنة</p>
  </CardFooter>
    </Card>
    <Button className="bg-white border-2 hover:text-white border-blue-900 text-blue-900 rounded-none py-0 mt-3">قراءة المزيد</Button>
   </div>
  );
};
