  ...
  const [show,setShow] = useState(false);
    switch (props.fieldType) {
      case FormFieldType.INPUT:
        return (
          <div className="flex items-center gap-3  relative rounded-md bg-dark-400">
            {props.iconSrc && (
              props.iconSrc
            )}
            <FormControl>
              <Input
                ...
                {...field}
                className={`border-0 py-4 text-[#015f6c] bg-gray-100 border-[#015f6c] focus:outline-none pl-9 font-bold`}
              />
            </FormControl>
          </div>
        );
        case FormFieldType.PASSWORD:
          return (
            <>
            <div className="flex items-center relative rounded-md bg-dark-400 ">
              {props.iconSrc && (
                props.iconSrc
              )}
              <FormControl>
                ...
                type={!show?"password":""}
                  placeholder={props.placeholder}
                  {...field}
                  className={`border-[1px] py-4 text-[#015f6c] bg-gray-100  pl-9 font-bold`}
                />
              </FormControl>
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem className="">
            ...
            <RenderInput field={field} className="" props={props} />
