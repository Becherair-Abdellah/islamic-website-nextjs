...
const CardSalaf = ({title,desc,date}) => {
  ...
  <CardHeader className="p-2">
    <CardTitle className="text-sm md:text-md text-blue-900 p-0 m-0 cursor-pointer">{title}</CardTitle>
  ...
  <CardFooter className="text-right p-2 text-sm md:text-md text-gray-600 flex items-center justify-between">
    ...
    <p className="p-1 border-2 text-sm md:text-md border-blue-950  hover:bg-blue-900 hover:text-white cursor-pointer">قراءة المزيد</p>
  </CardFooter>
</Card>
