...
const BookCard = ({ title, desc, downloads, imgSrc }) => {
    return (
      ...
      <div className="w-full md:w-2/3">
        <h2 className="text-lg md:text-xl font-bold text-[#015f6c] mb-2">{title}</h2>
        ...
        <div className="flex flex-col justify-end md:flex-row gap-2 md:gap-4">
          <button className="bg-[#015f6c] text-white px-4 py-2 rounded-md flex items-center text-sm w-full md:w-auto">
          ...
          <button className="bg-white border-2 border-[#015f6c] text-[#015f6c] px-4 py-2 flex items-center text-sm w-full md:w-auto">
